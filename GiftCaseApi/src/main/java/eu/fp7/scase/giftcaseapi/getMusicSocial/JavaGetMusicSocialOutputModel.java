...
import eu.fp7.scase.giftcaseapi.getMoviesSocial.ComplexProductsResponse;
import eu.fp7.scase.giftcaseapi.utilities.HypermediaLink;

/* 
 * JavaGetMusicSocialOutputModel class is responsible to model the output data model of the getMusicSocial resource. This models the data
 * that will be received as output from the third party service.
*/

@XmlRootElement
@JsonIgnoreProperties(ignoreUnknown = true)
public class JavaGetMusicSocialOutputModel{

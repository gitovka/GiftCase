...
/* 
 *This class processes client requests for getFacebookFriends resource that are to be delegated to an existing 3rd party service. 
...
*/
public class GetgetFacebookFriendsHandler{

    private HibernateController oHibernateController;
    private UriInfo oApplicationUri; //Standard datatype that holds information on the URI info of this request
	private JavaGetFacebookFriendsOutputModel oOutputDataModel;
	private String fields;
	private String access_token;
	private ClientConfig oClientConfiguration;

    public GetgetFacebookFriendsHandler(String fields, String access_token, UriInfo oApplicationUri){
    ...
    public JavaGetFacebookFriendsOutputModel getgetfacebookfriends(){
    ...
    */
    public JavaGetFacebookFriendsOutputModel interoperateWithExternalService(){
		
		//create a new JAX-RS client
        Client oJAXRSRESTClient = Client.create(this.oClientConfiguration);

		//construct the GET query
		WebResource oTargetResource = oJAXRSRESTClient.resource("https://graph.facebook.com/v2.6/me").queryParam("fields", this.fields).queryParam("access_token", this.access_token);
        ClientResponse oResponse = oTargetResource.accept(javax.ws.rs.core.MediaType.APPLICATION_JSON).get(ClientResponse.class);
        this.oOutputDataModel = oResponse.getEntity(JavaGetFacebookFriendsOutputModel.class);

...
public class GetUsersHandler{
    ...
    public GetUsersHandler(int UsersId, UriInfo oApplicationUri){
        oJavaUsersModel = new JavaUsersModel();
    ...
    public JavaUsersModel getJavaUsersModel(){


		return createHypermedia(oHibernateController.getUsers(oJavaUsersModel));
	}
